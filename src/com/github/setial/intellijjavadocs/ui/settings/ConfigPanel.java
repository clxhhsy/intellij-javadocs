...
public class ConfigPanel extends JPanel
{
    ...
    public boolean isModified()
    {
        ...
        result = result || isCheckboxModified(generalLevelTypeCheckbox,
            settings.getGeneralSettings().getLevels().contains(Level.TYPE));
        result = result || isCheckboxModified(generalLevelMethodCheckbox,
            settings.getGeneralSettings().getLevels().contains(Level.METHOD));
        result = result || isCheckboxModified(generalLevelFieldCheckbox,
            settings.getGeneralSettings().getLevels().contains(Level.FIELD));
        ...
        result = result || isCheckboxModified(generalOtherOverriddenMethodsCheckbox,
            settings.getGeneralSettings().isOverriddenMethods());
        result = result || isCheckboxModified(generalOtherSplittedClassName,
            settings.getGeneralSettings().isSplittedClassName());
    ...
    public void apply()
    {
        ...
        settings.getGeneralSettings().setOverriddenMethods(
            generalOtherOverriddenMethodsCheckbox.isSelected());
        settings.getGeneralSettings().setSplittedClassName(
            generalOtherSplittedClassName.isSelected());

        // apply templates settings
        settings.getTemplateSettings().setClassTemplates(classTemplatesTable.getSettings());
        settings.getTemplateSettings().setConstructorTemplates(
            constructorTemplatesTable.getSettings());
    ...
    public void reset()
    {
        ...
        generalOtherOverriddenMethodsCheckbox.setSelected(
            settings.getGeneralSettings().isOverriddenMethods());
        generalOtherSplittedClassName.setSelected(
            settings.getGeneralSettings().isSplittedClassName());

        // reset templates settings
        classTemplatesTable.setSettingsModel(settings.getTemplateSettings().getClassTemplates());
        constructorTemplatesTable.setSettingsModel(
            settings.getTemplateSettings().getConstructorTemplates());
                                                ...
                                                Map<String, String> templatesSettings)
    {
        ...
        Entry<String, String>[] templatesTableEntries = templatesTableSettings.entrySet().toArray(
            new Entry[templatesTableSettings.size()]);
        Entry<String, String>[] templatesEntries = templatesSettings.entrySet().toArray(
            new Entry[templatesSettings.size()]);
        if (templatesEntries.length == templatesTableEntries.length)
        {
            for (int i = 0; i < templatesEntries.length; i++ )
            {
                result = result || !templatesEntries[i].getKey().equals(
                    templatesTableEntries[i].getKey());
                result = result || !templatesEntries[i].getValue().equals(
                    templatesTableEntries[i].getValue());
            }
        }
        else
        {
    ...
    private void setupTemplatesPanel()
    {
        List<String> defaultColumnNames = Arrays.asList(
            new String[] {"Regular expression", "Preview"});
        List<String> variablesColumnNames = Arrays.asList(new String[]{"key","value"});
        classTemplatesTable = new TemplatesTable(
            settings.getTemplateSettings().getClassTemplates(),defaultColumnNames);
        JPanel classTemplatesLocalPanel = ToolbarDecorator.createDecorator(
            classTemplatesTable).createPanel();
        JPanel classPanel = new JPanel(new BorderLayout());
        classPanel.setBorder(
            IdeBorderFactory.createTitledBorder("Class level", false, new Insets(0, 0, 10, 0)));
        classPanel.add(classTemplatesLocalPanel, BorderLayout.CENTER);

        constructorTemplatesTable = new TemplatesTable(
            settings.getTemplateSettings().getConstructorTemplates(),defaultColumnNames);
        JPanel constructorTemplatesLocalPanel = ToolbarDecorator.createDecorator(
            constructorTemplatesTable).createPanel();
        ...
        methodTemplatesTable = new TemplatesTable(
            settings.getTemplateSettings().getMethodTemplates(),defaultColumnNames);
        JPanel methodTemplatesLocalPanel = ToolbarDecorator.createDecorator(
            methodTemplatesTable).createPanel();
        JPanel methodPanel = new JPanel(new BorderLayout());
        methodPanel.setBorder(
            IdeBorderFactory.createTitledBorder("Method level", false, new Insets(0, 0, 10, 0)));
        methodPanel.add(methodTemplatesLocalPanel, BorderLayout.CENTER);

        fieldTemplatesTable = new TemplatesTable(
            settings.getTemplateSettings().getFieldTemplates(),defaultColumnNames);
        JPanel fieldTemplatesLocalPanel = ToolbarDecorator.createDecorator(
            fieldTemplatesTable).createPanel();
        JPanel fieldPanel = new JPanel(new BorderLayout());
        fieldPanel.setBorder(
            IdeBorderFactory.createTitledBorder("Field level", false, new Insets(0, 0, 10, 0)));
        fieldPanel.add(fieldTemplatesLocalPanel, BorderLayout.CENTER);

        variablesTable = new TemplatesTable(
                settings.getTemplateSettings().getVariables(),variablesColumnNames);
        JPanel variablesLocalPanel = ToolbarDecorator.createDecorator(
                variablesTable).createPanel();
        JPanel variablesPanel = new JPanel(new BorderLayout());
        variablesPanel.setBorder(
                IdeBorderFactory.createTitledBorder("Additional variable", false, new Insets(0, 0, 0, 0)));
    ...
    {
        return new GridConstraints(row, column, 1, 1, GridConstraints.ANCHOR_CENTER,
    ...
    private void $$$setupUI$$$()
    {
        ...
        generalPanel.setBorder(
            BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0), null));
        generalModePanel = new JPanel();
        generalModePanel.setLayout(new GridLayoutManager(3, 1, new Insets(0, 0, 0, 0), -1, -1));
        generalPanel.add(generalModePanel,
            new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
                GridConstraints.FILL_BOTH,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null,
                null, null, 0, false));
        generalModePanel.setBorder(
            BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(3, 3, 3, 3), null));
        ...
        generalModePanel.add(generalModeKeepRadioButton,
            new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
        ...
        generalModePanel.add(generalModeUpdateRadioButton,
        ...
        generalModePanel.add(generalModeReplaceRadioButton,
        ...
        generalPanel.add(generalLevelPanel,
        ...
        generalLevelPanel.add(generalLevelTypeCheckbox,
            new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
                GridConstraints.FILL_HORIZONTAL,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        generalLevelPanel.add(generalLevelMethodCheckbox,
            new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
                GridConstraints.FILL_HORIZONTAL,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        generalLevelPanel.add(generalLevelFieldCheckbox,
            new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
                GridConstraints.FILL_HORIZONTAL,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        generalVisibilityPanel = new JPanel();
        generalVisibilityPanel.setLayout(
            new GridLayoutManager(4, 1, new Insets(0, 0, 0, 0), -1, -1));
        generalPanel.add(generalVisibilityPanel,
            new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER,
                GridConstraints.FILL_BOTH,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null,
                null, null, 0, false));
        generalVisibilityPanel.setBorder(BorderFactory.createTitledBorder(
            BorderFactory.createEmptyBorder(3, 3, 3, 3), "Visibility"));
        ...
        generalVisibilityPanel.add(generalVisibilityProtectedCheckbox,
            new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
                GridConstraints.FILL_HORIZONTAL,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        generalVisibilityPanel.add(generalVisibilityDefaultCheckbox,
            new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
                GridConstraints.FILL_HORIZONTAL,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        generalVisibilityPanel.add(generalVisibilityPrivateCheckbox,
        ...
        generalPanel.add(generalOtherPanel,
            new GridConstraints(1, 0, 1, 2, GridConstraints.ANCHOR_CENTER,
                GridConstraints.FILL_BOTH,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null,
                null, null, 0, false));
        generalOtherPanel.setBorder(BorderFactory.createTitledBorder(
            BorderFactory.createEmptyBorder(3, 3, 3, 3), "Other"));
        ...
        generalOtherPanel.add(generalOtherOverriddenMethodsCheckbox,
            new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
                GridConstraints.FILL_HORIZONTAL,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        generalOtherPanel.add(generalOtherSplittedClassName,
            new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
                GridConstraints.FILL_HORIZONTAL,
                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final Spacer spacer1 = new Spacer();
        generalPanel.add(spacer1,
            new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
